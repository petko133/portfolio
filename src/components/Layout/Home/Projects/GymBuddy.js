      ...
      <Container className={classes['inner-container']}>
        <Row className="justify-content-md-center">
          <Col className={classes.col}>
            <h3 className={classes['header-project']}>GYMBUDDY 🥊</h3>
            <p className={classes['project-info']}>
              A gym website that is a comprehensive resource for fitness
          ...
          <Col className={classes.colimg}>
            <img src={gymbuddy} alt="gymbuddy" className={classes.workplace} />
          </Col>
        </Row>
      </Container>
    </Container>
